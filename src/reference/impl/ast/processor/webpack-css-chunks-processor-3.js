import genericCssChunkProcess from "./webpack-css-chunks-processor.js"
...
export default function process(comparerResult) {
  ...
  while (true) {
    ...
    if (result1) {
      ...
      if (chunkIdAndfileName.startsWith(chunkId) && chunkIdAndfileName.endsWith(".css")) {
  ...
  return [ ... new Set([ ... genericCssChunkProcess(comparerResult), ... references ]) ];
}
